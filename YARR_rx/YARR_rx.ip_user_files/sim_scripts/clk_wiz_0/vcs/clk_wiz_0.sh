...
#
# Generated by Vivado on Fri May 06 10:04:32 -0700 2022
...
# Script info
echo -e "clk_wiz_0.sh - Script generated by export_simulation (Vivado v2020.1 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../YARR_rx.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../YARR_rx.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log

...
HD_PWD='C:/Users/User/Documents/YARR-rx-recovery/YARR_rx/YARR_rx.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vc709_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vc709_top.tcl -notrace

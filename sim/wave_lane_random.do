...
add wave -noupdate -radix unsigned /sim_aurora_lane/u_aurora_rx_lane/sync_cnt
add wave -noupdate -expand -group SEEs -radix unsigned /sim_aurora_lane/length_buffer
add wave -noupdate -expand -group SEEs -radix unsigned /sim_aurora_lane/length_block
add wave -noupdate -expand -group SEEs -radix unsigned /sim_aurora_lane/r_drop
add wave -noupdate -expand -group SEEs -radix unsigned /sim_aurora_lane/r_adds
add wave -noupdate -expand -group SEEs -radix unsigned /sim_aurora_lane/r_flip
add wave -noupdate -expand -group SEEs -radix unsigned /sim_aurora_lane/r_drop_bit
add wave -noupdate -expand -group SEEs -radix unsigned /sim_aurora_lane/r_adds_bit
add wave -noupdate -expand -group SEEs -radix unsigned /sim_aurora_lane/r_flip_bit
add wave -noupdate -expand -group SEEs /sim_aurora_lane/stream_buffer
add wave -noupdate -expand -group SEEs /sim_aurora_lane/untampered_block
add wave -noupdate -expand -group SEEs /sim_aurora_lane/tampered_block
...
WaveRestoreCursors {{Cursor 1} {1525542400000 fs} 0}
...
update
WaveRestoreZoom {1524685400 ps} {1535185400 ps}
